...
**Project**: emotion-needs-visualizer 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: A website for analyzing emotions in arbitrary situations using a model of emotions and a model of needs, allowing visualizations. 
...
```sh
git clone https://github.com/GPT-Engineer-App/emotion-needs-visualizer.git
cd emotion-needs-visualizer
npm i
